...
from helpers.network_utils import MVPViTLangAndFcsNet, ViT
    ...
    for cname in cameras:
        ...
        observation_elements.append(
            ObservationElement('%s_point_cloud' % cname, (3, *image_size),
                               np.int))  # see pyrep/objects/vision_sensor.py on how pointclouds are extracted from depth frames
        observation_elements.append(
...
def create_agent(camera_name: list,
                 activation: str,
                 lr: float,
                 weight_decay: float,
